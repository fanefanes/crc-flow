...
const dragCanvasBehavior: ThisType<DragCanvasBehavior & DefaultConfig> & DragCanvasBehavior = {
  origin: null,
  ...
  handleCanvasDragEnd(e) {
    if (!this.shouldEnd || !this.shouldEnd.call(this, e)) {
      return;
    }
    ...
    if (this.handleWindowMouseUp) {
      ...
      (this.handleWindowMouseUp as any) = null;
    }
  },
  ...
  handleCanvasMouseLeave() {
    ...
    if (this.handleWindowMouseUp as any) {
      return;
    }

    this.handleWindowMouseUp = (e: { target: any; }) => {
